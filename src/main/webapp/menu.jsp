        ...
        <div class="main">
          <aside>
			...
			if (user_id.equalsIgnoreCase("1") || user_id.equalsIgnoreCase("4")) {
				%>	
				<li> <a href="approval.jsp"><img src=common/images/icons/image2.png /> <span class="nav-label">List Of Approval</span></a> </li>
               ...
               <!--  <li> <a href="#" data-toggle="collapse" data-target="#dashboard" class="collapsed active"> <i
                ...
                <li> <a href="blockDetails.jsp"><img src=common/images/icons/listofapproval.png /> <span class="nav-label">Block</span></a> </li>
				<li> <a href="customerDetails.jsp"><img src=common/images/icons/listofapproval.png /> <span class="nav-label">Customer</span></a> </li>
                <li> <a href="LiveDashBoard.jsp"><img src=common/images/icons/listofapproval.png /> <span class="nav-label">DashBoard</span></a> </li>
                <li> <a href="topup.jsp"><img src=common/images/icons/listofapproval.png /> <span class="nav-label">Topup</span></a> </li>
                <li> <a href="topupStatus.jsp"><img src=common/images/icons/listofapproval.png /> <span class="nav-label">Topup Details</span></a> </li>
                <li> <a href="configuration.jsp"><img src=common/images/icons/listofapproval.png /> <span class="nav-label">Configuration</span></a> </li>
                <li> <a href="configurationStatus.jsp"><img src=common/images/icons/listofapproval.png /> <span class="nav-label">Configuration Status</span></a> </li>
                <li> <a href="#" data-toggle="collapse" data-target="#dashboard" class="collapsed active"> <i
                      class="fa fa-th-large"></i> <span class="nav-label"> Reports </span> <span
                      class="fa fa-chevron-left float-right"></span> </a>
                  <ul class="sub-menu collapse" id="dashboard">
                  <li class=""><a href="userConsumptions.jsp"><img src=common/images/icons/listofapproval.png /><span class="nav-label">User Consumptions</span></a></li>
                    <li><a href="topupSummary.jsp"><img src=common/images/icons/listofapproval.png /><span class="nav-label">Top Up Summary</span></a></li>
                    <li><a href="financialreports.jsp"><img src=common/images/icons/listofapproval.png /><span class="nav-label">Financial Reports</span></a></li>
                    <li><a href="alarms.jsp"><img src=common/images/icons/listofapproval.png /><span class="nav-label">Alarms</span></a></li>
