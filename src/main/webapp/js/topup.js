													...
													success : function(
														...
														if (data.result == "Success") {
															...
															let template = `<form action="http://localhost:8080/PAYGTL_LORA_BLE/checkout" method="POST">
															    ...
															    data-currency=${data.checkoutDetails.currency}//You can accept international payments by changing the currency code. Contact our Support Team to enable International for your account
															    data-order_id=${data.checkoutDetails.orderID}//Replace with the order_id generated by you in the backend.
															    data-buttontext=${data.checkoutDetails.buttonText} 
															    data-name=${data.checkoutDetails.name}
															    data-description=${data.checkoutDetails.description}
															    data-image=${data.checkoutDetails.image}
															    data-prefill.name=${data.checkoutDetails.customerName}
															    data-prefill.email=${data.checkoutDetails.customerEmail}
															    data-prefill.contact=${data.checkoutDetails.mobileNumber}
															    data-theme.color=${data.checkoutDetails.themeColor}
