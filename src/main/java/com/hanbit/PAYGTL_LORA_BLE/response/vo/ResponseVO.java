...
public class ResponseVO {
	...
	private List<TopupDetailsResponseVO> topupdetails;
	...
	public List<TopupDetailsResponseVO> getTopupdetails() {
		return topupdetails;
	}
	public void setTopupdetails(List<TopupDetailsResponseVO> topupdetails) {
